export default class Pagination {
	...
	constructor(displayCount: number, selectElem: HTMLSelectElement, prevButton: HTMLButtonElement, nextButton: HTMLButtonElement) {
		...
		this.selectElem.onchange = (e) => this.changePageAndCallback(Number((e.target as HTMLSelectElement).value))
		this.prevButton.onclick = () => this.changePageAndCallback(this.currentPage - 1)
		this.nextButton.onclick = () => this.changePageAndCallback(this.currentPage + 1)
	}
